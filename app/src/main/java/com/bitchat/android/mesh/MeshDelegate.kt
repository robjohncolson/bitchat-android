...
interface MeshDelegate {
    ...
    fun didReceivePaymentBroadcastRequest(peerID: String, payload: ByteArray, timestampMs: Long) {}
    fun didReceivePaymentBroadcastResult(peerID: String, payload: ByteArray, timestampMs: Long) {}
